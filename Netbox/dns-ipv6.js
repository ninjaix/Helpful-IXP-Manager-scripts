...
mycon.query(
'SELECT concat(`ixpmanager`.`vlaninterface`.`ipv6hostname`,".",`ixpmanager`.`vlan`.`name`,".IX.Ninja-IX.net"),`ixpmanager`.`vlaninterface`.'+
'`ipv4canping`,concat(`ipv6address`.`address`,"/64"), `ixpmanager`.`cust`.`name`, `ixpmanager`.`vlan`.`number`,`ixpmanager`.`ipv6address`.`updated_at`,'+
